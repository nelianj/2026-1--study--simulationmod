# # Агентная модель SIR с карантинными мерами
#
# **Цель:** Модифицировать модель SIR, добавив возможность закрытия городов
# при превышении порога заболеваемости, и оценить эффективность таких мер.
#
...
# ## Модифицированная функция инициализации модели с поддержкой карантина
...
# ## Функция проверки и применения карантинных мер
...
# ## Функция запуска эксперимента с карантином
...
# ## Функция запуска эксперимента без карантина
...
# График 1: Сравнение с разными порогами
plot1 = plot(
    xlabel = "Дни",
...
# График 2: Сравнение с разной длительностью
plot2 = plot(
    xlabel = "Дни",
    ylabel = "Доля инфицированных, %",
