...
DE modify state:
12.03 secs, 2 evals, 1 steps, improv/step: 1.000 (last = 1.0000), fitness=1000.000000000
DE modify state:
16.85 secs, 4 evals, 2 steps, improv/step: 1.000 (last = 1.0000), fitness=1000.000000000
DE modify state:
18.90 secs, 7 evals, 4 steps, improv/step: 0.750 (last = 0.5000), fitness=0.000000000
DE modify state:
23.84 secs, 9 evals, 5 steps, improv/step: 0.800 (last = 1.0000), fitness=0.000000000
DE modify state:
25.53 secs, 11 evals, 6 steps, improv/step: 0.667 (last = 0.0000), fitness=0.000000000
DE modify state:
26.51 secs, 13 evals, 8 steps, improv/step: 0.750 (last = 1.0000), fitness=0.000000000
DE modify state:
41.78 secs, 15 evals, 9 steps, improv/step: 0.778 (last = 1.0000), fitness=0.000000000
DE modify state:
51.72 secs, 17 evals, 10 steps, improv/step: 0.800 (last = 1.0000), fitness=0.000000000
DE modify state:
52.73 secs, 19 evals, 11 steps, improv/step: 0.818 (last = 1.0000), fitness=0.000000000
DE modify state:
53.75 secs, 20 evals, 12 steps, improv/step: 0.750 (last = 0.0000), fitness=0.000000000
DE modify state:

Optimization stopped after 13 steps and 67.23 seconds
Termination reason: Max time (60.0 s) reached
Steps per second = 0.19
Function evals per second = 0.33
Improvements/step = Inf
Total function evaluations = 22


Best candidate found: [0.157229, 8.23394, 0.0949412]

Fitness: 0.000000000
\end{verbatim}

\begin{verbatim}
BlackBoxOptim.OptimizationResults("adaptive_de_rand_1_bin", "Max time (60.0 s) reached", 13, 1.775334295148341e9, 67.23150110244751, ParamsDictChain[ParamsDictChain[Dict{Symbol, Any}(:NumDimensions => 3, :MaxTime => 60.0, :SearchRange => [(0.1, 1.0), (3.0, 14.0), (0.01, 0.1)], :TraceMode => :none, :Method => :adaptive_de_rand_1_bin, :MaxFuncEvals => 0, :MaxSteps => 0, :PopulationSize => 20),Dict{Symbol, Any}()],Dict{Symbol, Any}(:CallbackInterval => -1.0, :TargetFitness => nothing, :TraceMode => :compact, :FitnessScheme => ScalarFitnessScheme{true}(), :MinDeltaFitnessTolerance => 1.0e-50, :NumDimensions => :NotSpecified, :FitnessTolerance => 1.0e-8, :TraceInterval => 0.5, :MaxStepsWithoutProgress => 10000, :MaxSteps => 10000…)], 22, ScalarFitnessScheme{true}(), BlackBoxOptim.TopListArchiveOutput{Float64, Vector{Float64}}(0.0, [0.15722949228924504, 8.233939084531034, 0.09494119642175618]), BlackBoxOptim.PopulationOptimizerOutput{FitPopulation{Float64}}(FitPopulation{Float64}([0.977478938532539 0.7874292055415524 … 0.2866954284119132 0.8947272606370639; 5.391996369956745 8.489238619895252 … 10.083091802107129 10.581333586341243; 0.012990774782420111 0.09654005353922351 … 0.046812557937241164 0.09269370148357477], NaN, [NaN, NaN, NaN, NaN, NaN, 1000.0, NaN, 1000.0, NaN, NaN, NaN, 0.0, 0.0, 0.0, 1000.0, 1000.0, NaN, NaN, NaN, NaN], 0, BlackBoxOptim.Candidate{Float64}[BlackBoxOptim.Candidate{Float64}([0.9466936246351442, 4.3337830848906, 0.05631501353614527], 16, 1000.0, BlackBoxOptim.AdaptiveDiffEvoRandBin{3}(BlackBoxOptim.AdaptiveDiffEvoParameters(BlackBoxOptim.BimodalCauchy(Distributions.Cauchy{Float64}(μ=0.65, σ=0.1), Distributions.Cauchy{Float64}(μ=1.0, σ=0.1), 0.5, false, true), BlackBoxOptim.BimodalCauchy(Distributions.Cauchy{Float64}(μ=0.1, σ=0.1), Distributions.Cauchy{Float64}(μ=0.95, σ=0.1), 0.5, false, true), [0.6551007338291316, 0.16953378789362467, 0.6382447868789556, 0.31190742778215524, 0.7238600076892279, 1.0, 0.8144211961752433, 1.0, 0.9765270090080724, 0.6080581695143009, 0.40968335372393794, 0.6757095505630982, 0.14762353391610916, 0.8271610320461629, 0.9645403279983206, 0.5351877875252933, 0.4523610016726574, 0.7261993450200346, 1.0, 0.6479716776199356], [0.22343399965238256, 0.901948637516552, 0.9950297292731218, 1.0, 0.9097268567191358, 0.9981764355284444, 0.07475104216957593, 0.5455511171667776, 0.2923014679934694, 0.9023490389146236, 0.1631088262777653, 1.0, 1.0, 0.9047142838868117, 0.056480290591938986, 0.08801841557449566, 0.8600649026871915, 0.7275612778445493, 0.11210779222839534, 1.0])), 0), BlackBoxOptim.Candidate{Float64}([0.9466936246351442, 13.007560726317019, 0.07973793471003728], 16, 1000.0, BlackBoxOptim.AdaptiveDiffEvoRandBin{3}(BlackBoxOptim.AdaptiveDiffEvoParameters(BlackBoxOptim.BimodalCauchy(Distributions.Cauchy{Float64}(μ=0.65, σ=0.1), Distributions.Cauchy{Float64}(μ=1.0, σ=0.1), 0.5, false, true), BlackBoxOptim.BimodalCauchy(Distributions.Cauchy{Float64}(μ=0.1, σ=0.1), Distributions.Cauchy{Float64}(μ=0.95, σ=0.1), 0.5, false, true), [0.6551007338291316, 0.16953378789362467, 0.6382447868789556, 0.31190742778215524, 0.7238600076892279, 1.0, 0.8144211961752433, 1.0, 0.9765270090080724, 0.6080581695143009, 0.40968335372393794, 0.6757095505630982, 0.14762353391610916, 0.8271610320461629, 0.9645403279983206, 0.5351877875252933, 0.4523610016726574, 0.7261993450200346, 1.0, 0.6479716776199356], [0.22343399965238256, 0.901948637516552, 0.9950297292731218, 1.0, 0.9097268567191358, 0.9981764355284444, 0.07475104216957593, 0.5455511171667776, 0.2923014679934694, 0.9023490389146236, 0.1631088262777653, 1.0, 1.0, 0.9047142838868117, 0.056480290591938986, 0.08801841557449566, 0.8600649026871915, 0.7275612778445493, 0.11210779222839534, 1.0])), 0)], Base.Threads.SpinLock(0))))
\end{verbatim}
